        ...
        <div className="profile-page">
            ...
            <div className="profile-page__edit">
                <div className="profile-page__section">
                    ...
                    <EditProfile label="Username" value={profile.user.city} onSave={(newValue) => handleSave("user", "username", newValue)}/>
                ...
                <div className="profile-page__section">
                    ...
                    <EditProfile label="Dog Personality" value={profile.dog.personality} onSave={(newValue) => handleSave("dog", "username", newValue)}/>
